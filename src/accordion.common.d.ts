...
export declare const rowHeightProperty: CoercibleProperty<AccordionBase, Length>;
export declare const iosEstimatedRowHeightProperty: Property<AccordionBase, Length>;
